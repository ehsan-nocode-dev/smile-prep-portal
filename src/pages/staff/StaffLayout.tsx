...
import { LayoutDashboard, ClipboardList, Trophy, UserCircle2, Store } from "lucide-react";
...
const items: NavItem[] = [
  ...
  { to: "/staff/store", label: "Crown Store", icon: <Store className="h-4 w-4" /> },
